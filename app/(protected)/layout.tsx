...
<div className="w-full max-w-md">
    ...
    <div className="flex items-center justify-center gap-3 mb-10">
      <PlusLogo size={36} />
      <span className="text-2xl font-bold text-gray-900 tracking-tight lowercase">
        plus company <span className="text-gray-400 font-semibold">Forecaster</span>
      </span>
    </div>
    ...
    <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm text-center">
      ...
      <a
        ...
        className="inline-block text-sm font-medium text-purple-700 hover:text-purple-600 transition-colors mb-8"
      >
      ...
      <button
        onClick={signOut}
        className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-gray-200 text-sm font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-900 transition-colors"
      >
        <LogOut size={15} />
        Sign out
      </button>
...
<div className="flex min-h-screen bg-gray-50">
  ...
  {/*
    ...
    — Desktop: sticky, full viewport height (h-screen),
  ...
  */}
  ...
  <div className="flex flex-col flex-1 min-w-0">
    ...
    {/* Topbar — mobile only, sticky so it stays visible on scroll */}
    <header className="lg:hidden sticky top-0 z-20 flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200">
      ...
      <span className="flex items-center gap-2 font-bold text-gray-900 tracking-tight lowercase">
        <PlusLogo size={22} />
        plus company
        <span className="rounded bg-yellow-400 px-1.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-gray-900">
          Forecaster
        </span>
      </span>
      <div className="w-8" />
    ...
    {/* Page content — the body scrolls, the sidebar stays pinned */}
