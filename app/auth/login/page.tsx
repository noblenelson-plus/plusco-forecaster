...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-gray-50 p-4">
      ...
      <div className="w-full max-w-lg overflow-hidden border border-gray-200 bg-white">
        ...
        <div className="p-8">
          ...
          <div className="flex items-end gap-2">
            ...
            <span className="mb-1.5 bg-green-500 px-1.5 py-0.5 text-xs font-bold text-white">
              ▲ live
            </span>
          </div>
          ...
          <button
            ...
            disabled={signingIn}
            className="mt-7 flex w-full items-center justify-center gap-3 bg-yellow-400 px-6 py-3 font-semibold text-gray-900 transition-all hover:scale-[1.02] hover:bg-yellow-300 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <svg className="h-5 w-5 bg-white p-0.5" viewBox="0 0 24 24">
