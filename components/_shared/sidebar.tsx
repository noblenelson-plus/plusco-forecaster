// filepath: components/_shared/sidebar.tsx
"use client";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Forecaster",   href: "/forecaster",  icon: null,                          section: "main", isSubItem: true },
    ...
    return (
      <li>
        <Link
          ...
          onClick={onClose}
          className={`
            flex items-center gap-3 px-3 py-2 ml-7 border-l-2 text-sm font-medium transition-colors
            ${isActive
